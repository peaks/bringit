...
import 'package:git_ihm/model/git/static/commits.dart';
import 'package:git_ihm/presentation/widget/commit/commit_info.dart';
import 'package:git_ihm/presentation/widget/commit/commit_timestamp.dart';
import 'package:git_ihm/presentation/widget/commit/info_user_commit.dart';
import 'package:git_ihm/presentation/widget/shared/user_profile_picture.dart';
...
class CommitSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String formattedDate = formatDate(commit.date);
