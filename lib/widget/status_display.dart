...
import 'package:git_ihm/data/git/git_factory.dart';
import 'package:git_ihm/data/git_proxy.dart';
import 'package:git_ihm/widget/stagingFileList.dart';

import '../data/git/status_file.dart';
import '../helpers/wording.dart';
import 'button/staging_g_button.dart';
...
class _StatusDisplayState extends State<StatusDisplay> {
  List<StatusFile> staged = <StatusFile>[];
  List<StatusFile> unstaged = <StatusFile>[];
  List<StatusFile> untracked = <StatusFile>[];
  GitProxy? git;
  ...
  Widget build(BuildContext context) {
    ...
    untracked = git!.gitState
        .where((StatusFile element) => element.fileState == null)
        .toList();
    staged = git!.gitState
        .where((StatusFile element) =>
