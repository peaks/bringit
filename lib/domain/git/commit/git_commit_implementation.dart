...
class GitCommitImplementation extends GitCommitCommand {
  GitCommitImplementation();

  @override
  Future<CommandResult<String>> run(
      String commitMessage, String workingDirectoryPath) async {
    final ShellCommand command =
        ShellCommand('git', <String>['commit', '-m', commitMessage]);
