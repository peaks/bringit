...
const int _r = 0xE001;
const int _apple = 0xE002;
const int _argdown = 0xE003;
const int _asm = 0xE004;
const int _audio = 0xE005;
const int _babel = 0xE006;
const int _bower = 0xE007;
const int _bsl = 0xE008;
const int _c_sharp = 0xE009;
const int _c = 0xE00A;
const int _cake = 0xE00B;
const int _cake_php = 0xE00C;
const int _checkbox_unchecked = 0xE00D;
const int _checkbox = 0xE00E;
const int _cjsx = 0xE00F;
const int _clock = 0xE010;
const int _clojure = 0xE011;
const int _code_climate = 0xE012;
const int _code_search = 0xE013;
const int _coffee = 0xE014;
const int _coffee_erb = 0xE015;
const int _coldfusion = 0xE016;
const int _config = 0xE017;
const int _cpp = 0xE018;
const int _crystal = 0xE019;
const int _crystal_embedded = 0xE01A;
const int _css = 0xE01B;
const int _csv = 0xE01C;
const int _d = 0xE01D;
const int _dart = 0xE01E;
const int _db = 0xE01F;
const int _default = 0xE020;
const int _deprecation_cop = 0xE021;
const int _docker = 0xE022;
const int _editorconfig = 0xE023;
const int _ejs = 0xE024;
const int _elixir = 0xE025;
const int _elixir_script = 0xE026;
const int _elm = 0xE027;
const int _error = 0xE028;
const int _eslint = 0xE029;
const int _ethereum = 0xE02A;
const int _f_sharp = 0xE02B;
const int _favicon = 0xE02C;
const int _firebase = 0xE02D;
const int _firefox = 0xE02E;
const int _folder = 0xE02F;
const int _font = 0xE030;
const int _git = 0xE031;
const int _git_folder = 0xE032;
const int _git_ignore = 0xE033;
const int _github = 0xE034;
const int _go = 0xE035;
const int _go2 = 0xE036;
const int _gradle = 0xE037;
const int _grails = 0xE038;
const int _graphql = 0xE039;
const int _grunt = 0xE03A;
const int _gulp = 0xE03B;
const int _hacklang = 0xE03C;
const int _haml = 0xE03D;
const int _happenings = 0xE03E;
const int _haskell = 0xE03F;
const int _haxe = 0xE040;
const int _heroku = 0xE041;
const int _hex = 0xE042;
const int _html = 0xE043;
const int _html_erb = 0xE044;
const int _ignored = 0xE045;
const int _illustrator = 0xE046;
const int _image = 0xE047;
const int _info = 0xE048;
const int _ionic = 0xE049;
const int _jade = 0xE04A;
const int _java = 0xE04B;
const int _javascript = 0xE04C;
const int _jenkins = 0xE04D;
const int _jinja = 0xE04E;
const int _js_erb = 0xE04F;
const int _json = 0xE050;
const int _julia = 0xE051;
const int _karma = 0xE052;
const int _kotlin = 0xE053;
const int _less = 0xE054;
const int _license = 0xE055;
const int _liquid = 0xE056;
const int _livescript = 0xE057;
const int _lock = 0xE058;
const int _lua = 0xE059;
const int _makefile = 0xE05A;
const int _markdown = 0xE05B;
const int _maven = 0xE05C;
const int _mdo = 0xE05D;
const int _mustache = 0xE05E;
const int _new_file = 0xE05F;
const int _npm = 0xE060;
const int _npm_ignored = 0xE061;
const int _nunjucks = 0xE062;
const int _ocaml = 0xE063;
const int _odata = 0xE064;
const int _pddl = 0xE065;
const int _pdf = 0xE066;
const int _perl = 0xE067;
const int _photoshop = 0xE068;
const int _php = 0xE069;
const int _plan = 0xE06A;
const int _platformio = 0xE06B;
const int _powershell = 0xE06C;
const int _project = 0xE06D;
const int _pug = 0xE06E;
const int _puppet = 0xE06F;
const int _python = 0xE070;
const int _rails = 0xE071;
const int _react = 0xE072;
const int _reasonml = 0xE073;
const int _rollup = 0xE074;
const int _ruby = 0xE075;
const int _rust = 0xE076;
const int _salesforce = 0xE077;
const int _sass = 0xE078;
const int _sbt = 0xE079;
const int _scala = 0xE07A;
const int _search = 0xE07B;
const int _settings = 0xE07C;
const int _shell = 0xE07D;
const int _slim = 0xE07E;
const int _smarty = 0xE07F;
const int _spring = 0xE080;
const int _stylelint = 0xE081;
const int _stylus = 0xE082;
const int _sublime = 0xE083;
const int _svg = 0xE084;
const int _swift = 0xE085;
const int _terraform = 0xE086;
const int _tex = 0xE087;
const int _time_cop = 0xE088;
const int _todo = 0xE089;
const int _tsconfig = 0xE08A;
const int _twig = 0xE08B;
const int _typescript = 0xE08C;
const int _vala = 0xE08D;
const int _video = 0xE08E;
const int _vue = 0xE08F;
const int _wasm = 0xE090;
const int _wat = 0xE091;
const int _webpack = 0xE092;
const int _wgt = 0xE093;
const int _windows = 0xE094;
const int _word = 0xE095;
const int _xls = 0xE096;
const int _xml = 0xE097;
const int _yarn = 0xE098;
const int _yml = 0xE099;
const int _zip = 0xE09A;
const int _white = 0xffd4d7d6;
const int _grey = 0xff4d5a5e;
const int _grey_light = 0xff6d8086;
const int _blue = 0xff519aba;
const int _green = 0xff8dc149;
const int _orange = 0xffe37933;
const int _pink = 0xfff55385;
const int _purple = 0xffa074c4;
const int _red = 0xffcc3e44;
const int _yellow = 0xffcbcb41;
const int _ignore = 0xff41535b;
const int _seti_primary = _blue;
const Map<String, SetiMeta> iconSetMap = <String, SetiMeta>{
  ...
  '.gitignore': SetiMeta(_git_ignore, _ignore),
